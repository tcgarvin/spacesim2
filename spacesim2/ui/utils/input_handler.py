...
class InputHandler:
    ...
    def register_key_callback(
        self, key: int, callback: Callable[[Event], Optional[bool]]
    ) -> None:
    ...
    def register_mouse_click_callback(
        self, button: int, callback: Callable[[Event], None]
    ) -> None:
    ...
    def register_mouse_scroll_callback(
        self, direction: int, callback: Callable[[Event], None]
    ) -> None:
