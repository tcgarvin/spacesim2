        ...
        for _ in range(num_turns):
            ...
            for actor in self.simulation.data_logger.get_all_logged_actors():
                ...
                if current_orders:
                    ...
                    print("    Currently Open Orders: None")
                ...
                if transactions:
                    ...
                    print("    Transactions This Turn: None")
